...
class CurrencyService extends ApiService {
  ...
  Future<RestResponse<Currency>> retrieveCurrencyById(int id) async {
    return request(
  ...
  Future<RestResponse<bool>> deleteCurrencyById(int id) async {
  ...
  Future<RestResponse<Currency>> updateCurrencyById(int id,
